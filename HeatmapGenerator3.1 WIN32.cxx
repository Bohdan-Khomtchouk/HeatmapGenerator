...
// To compile this source code, do: fltk-config --use-images --use-gl --compile HeatmapGenerator_WIN32.cxx
...
void Butt_CB(Fl_Widget*, void*) {
	...
	if (heatmap2 == 1) {
		...
		//myfile << "install.packages(\"gplots_2.14.2.tar.gz\", repos=NULL, type=\"source\")\n"; <-changed to reflect an absence of gplots
		myfile << "if (\"gplots\" \%in\% installed.packages()[,\"Package\"] == FALSE) install.packages(\"gplots\", dependencies = NA, repos=\"https://cran.us.r-2Dproject.org\", type=\"source\")\n";
...
void instructions_callback(Fl_Widget*, void*)
{
	...
	{ new Fl_Box(150, 115, 160, 20, "Please make sure that the file you choose is:\n\n    #1) A .txt file\
        \
\n #2) Tab-delimited\n #3) First labeled column has gene names, with first gene in the second row\n #4) Rest \
of labeled columns consist of numbers,  with first numbers\n in the second row\n #5) ***Refer to \
HeatmapGenerator publication for input example");
	} // Fl_Box* o
	o->end();
	o->show();
