...
# This R code is embedded and used within older versions of HeatmapGenerator (before version 4.0) for Mac OS X and Windows OS.  Line 35 (gplots conditional installation has been active since version 3.0)
