// Copyright (C) 2014-2016 Khomtchouk et al.
...
int main(int argc, char **argv, const char *env[], const char *path[]) {
	...
	Fl_Double_Window* w;
	{ Fl_Double_Window* o = new Fl_Double_Window(601, 361, "HeatmapGenerator5");
	w = o;
...
//	browser->when(FL_WHEN_RELEASE);
	...
	{ new Fl_Box(25, 3, 215, 25, "Welcome to HeatmapGenerator5!");
	} // Fl_Box* o
...
void instructions_callback(Fl_Widget*, void*)
{
       ...
       { new Fl_Box(150, 115, 160, 20, "Please read HeatmapGenerator5 Manual downloaded with\nthis program before use.\n\n  \
