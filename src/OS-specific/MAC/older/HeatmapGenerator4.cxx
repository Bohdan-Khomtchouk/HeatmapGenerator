...
// Copyright (C) 2014-2015 Khomtchouk et al.
...
void Butt_CB(Fl_Widget*, void*) {
	...
	if (heatmap2 == 1) {
		...
		myfile << "if (\"gplots\" \%in\% installed.packages()[,\"Package\"] == FALSE) install.packages(\"gplots\", dependencies = NA, repos=\"http://cran.us.r-project.org\", type=\"source\")\n";
		...
		myfile << "heatmap.2(genexp, trace=\"none\", dendrogram=\"both\", Rowv=TRUE, Colv=TRUE, col = colorpanel (256, low=\"" + lowval + "\", high=\"" + highval + "\"), margins=c(15,15))\n";
		myfile << "outfile <- \"" + fname + ".jpg\"\n";
		myfile << "jpeg(outfile , width=20, height=20, units=\"cm\", res=600)\n";
		myfile << "heatmap.2(genexp, trace=\"none\", dendrogram=\"both\", Rowv=TRUE, Colv=TRUE, col = colorpanel (256, low=\"" + lowval + "\", high=\"" + highval + "\"), margins=c(15,15))\n";
		...
		myfile << "heatmap(genexp, Rowv=NA, Colv=NA, col = colorpanel (256, low=\"" + lowval + "\", high=\"" + highval + "\"), margins=c(15,15))\n";
		myfile << "outfile <- \"" + fname + ".jpg\"\n";
		myfile << "jpeg(outfile , width=20, height=20, units=\"cm\", res=600)\n";
		myfile << "heatmap(genexp, Rowv=NA, Colv=NA, col = colorpanel (256, low=\"" + lowval + "\", high=\"" + highval + "\"), margins=c(15,15))\n";
		myfile << "dev.off(which = dev.cur())\n}\nHeatmapGenerator()\nrm(HeatmapGenerator)\n";
...
int main(int argc, char **argv, const char *env[], const char *path[]) {
	...
	Fl_Double_Window* w;
	{ Fl_Double_Window* o = new Fl_Double_Window(601, 361, "HeatmapGenerator4");
	w = o;
...
//	browser->when(FL_WHEN_RELEASE);
        ...
        std::string filepath1 = s.substr(0,s.size()-18);
	...
	{ new Fl_Box(25, 3, 215, 25, "Welcome to HeatmapGenerator4!");
	} // Fl_Box* o
	{ Fl_Check_Button* o = new Fl_Check_Button(459, 249, 55, 25, "PNG");
	...
	{ Fl_Check_Button* o = new Fl_Check_Button(531, 249, 55, 25, "JPG");
	o->down_box(FL_DOWN_BOX);
	jpg = 0;
	o->callback(jpeg1);
	} // Fl_Check_Button* o
...
void about_callback(Fl_Widget* obj, void*)
{
	...
	{ new Fl_Box(150, 115, 160, 95, "Copyright 2014-2015 Khomtchouk et al.\n\n http://psychiatry.med.miami.edu/research/resources/heatmapgenerator\n\n This program is \
...
void instructions_callback(Fl_Widget*, void*)
{
       ...
       { new Fl_Box(150, 115, 160, 20, "Please read HeatmapGenerator4 Manual downloaded with\nthis program before use.\n\n  \
