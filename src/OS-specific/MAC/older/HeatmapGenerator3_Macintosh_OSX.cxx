...
void Butt_CB(Fl_Widget*, void*) {
	...
	if (heatmap2 == 1) {
		...
		myfile << "if (\"gplots\" \%in\% installed.packages()[,\"Package\"] == FALSE) install.packages(\"http://cran.rstudio.com/bin/macosx/mavericks/contrib/3.2/gplots_2.17.0.tgz\", repos=NULL, type=\"source\")\n";
...
int main(int argc, char **argv, const char *env[], const char *path[]) {
	...
	Fl_Double_Window* w;
	{ Fl_Double_Window* o = new Fl_Double_Window(601, 361, "HeatmapGenerator3");
	w = o;
	...
	{ new Fl_Box(25, 3, 215, 25, "Welcome to HeatmapGenerator3!");
	} // Fl_Box* o
...
void instructions_callback(Fl_Widget*, void*)
{
       ...
       { new Fl_Box(150, 115, 160, 20, "Please read HeatmapGenerator3 Manual downloaded with\nthis program before use.\n\n  \
