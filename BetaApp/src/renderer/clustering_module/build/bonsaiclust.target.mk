...
$(builddir)/bonsaiclust.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/bonsaiclust.a: LIBS := $(LIBS)
$(builddir)/bonsaiclust.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/bonsaiclust.a: TOOLSET := $(TOOLSET)
$(builddir)/bonsaiclust.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(builddir)/bonsaiclust.a
# Add target alias
.PHONY: bonsaiclust
bonsaiclust: $(builddir)/bonsaiclust.a
...
.PHONY: bonsaiclust.a
bonsaiclust.a: $(builddir)/bonsaiclust.a

# Add static library to "all" target.
.PHONY: all
all: $(builddir)/bonsaiclust.a
