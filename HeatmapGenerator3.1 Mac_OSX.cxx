...
int main(int argc, char **argv, const char *env[], const char *path[]) {
	...
	Fl_Double_Window* w;
	{ Fl_Double_Window* o = new Fl_Double_Window(601, 361, "HeatmapGenerator3.1");
	w = o;
	...
	{ new Fl_Box(25, 3, 215, 25, "Welcome to HeatmapGenerator3.1!");
	} // Fl_Box* o
...
void instructions_callback(Fl_Widget*, void*)
{
       ...
       { new Fl_Box(150, 115, 160, 20, "Please read HeatmapGenerator3.1 Manual downloaded with\nthis program before use.\n\n  \
